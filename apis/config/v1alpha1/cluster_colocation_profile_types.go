...
type ClusterColocationProfileSpec struct {
	...
	// QoSClass describes the type of Kooperator QoS that the Pod is running.
	// The value will be injected into Pod as label kooperator/qosClass.
	...
	// KooperatorPriority will affect the scheduling, preemption and
	// other behaviors of Kooperator system.
	// +kubebuilder:validation:Enum=koord-prod;koord-mid;koord-batch;koord-free
	// +required
	PriorityClassName string `json:"priorityClassName"`

	// KooperatorPriority defines the Pod sub-priority in Kooperator.
	// The priority value will be injected into Pod as label kooperator/priority.
	// Various Kooperator components determine the priority of the Pod
	// in the Kooperator through KooperatorPriority and the priority value in PriorityClassName.
	// The higher the value, the higher the priority.
	// +optional
	KooperatorPriority *int32 `json:"kooperatorPriority,omitempty"`
