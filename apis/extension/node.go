...
const (
	...
	// AnnotationNodeCPUSharedPools describes the CPU Shared Pool defined by Kooperator.
	// The shared pool is mainly used by Kooperator LS Pods or K8s Burstable Pods.
...
const (
	...
	AnnotationKubeletCPUManagerPolicy = "kubelet.kooperator/cpu-manager-policy"
