...
import (
	...
	deschedulerscheme "Kooperator/pkg/descheduler/apis/config/scheme"
	"Kooperator/pkg/descheduler/apis/config/v1alpha2"
	"Kooperator/pkg/descheduler/apis/config/validation"
	"Kooperator/pkg/descheduler/informers"
...
func NewOptions() *Options {
	...
	o := &Options{
		...
		LeaderElection: &componentbaseconfig.LeaderElectionConfiguration{
			...
			ResourceNamespace: "kooperator-system",
		},
