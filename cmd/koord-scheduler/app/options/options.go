...
import (
	...
	schedulerappconfig "Kooperator/cmd/koord-scheduler/app/config"
...
func (o *Options) Config() (*schedulerappconfig.Config, error) {
	...
	kooperatorClient, err := kooperatorclientset.NewForConfig(&kubeConfig)
	if err != nil {
		return nil, err
	}
	kooperatorSharedInformerFactory := kooperatorinformers.NewSharedInformerFactoryWithOptions(kooperatorClient, 0)
	...
	return &schedulerappconfig.Config{
		Config:                          config,
		KooperatorClient:                kooperatorClient,
		KooperatorSharedInformerFactory: kooperatorSharedInformerFactory,
