...
import (
	...
	"Kooperator/cmd/koord-scheduler/app"
	"Kooperator/pkg/scheduler/frameworkext"
	"Kooperator/pkg/scheduler/plugins/compatibledefaultpreemption"
	"Kooperator/pkg/scheduler/plugins/loadaware"
	"Kooperator/pkg/scheduler/plugins/nodenumaresource"
	"Kooperator/pkg/scheduler/plugins/reservation"

	// Ensure scheme package is initialized.
	_ "Kooperator/apis/scheduling/config/scheme"
)
