...
pre_sched_utilization_small = [0.8, 0.2, 0.76]  # Skewed utilization for 3 nodes
post_sched_proposed_small = [0.56, 0.64, 0.6]  # Balanced utilization for proposed method
post_sched_lyra_small = [0.7, 0.4, 0.64]  # Lyra method
post_sched_pollux_small = [0.74, 0.3, 0.68]  # Pollux method
...
plt.ylabel(u"节\n点\nCPU\n利\n用\n率", rotation=0, labelpad=20, ha='left',fontsize=14, y=0.35)  # labelpad调整距离，ha调整对齐方式
plt.title(u"重调度前后节点 CPU 利用率对比",fontsize=16)
