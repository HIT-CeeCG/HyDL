...
var nodeslosResource = schema.GroupVersionResource{Group: "slo.kooperator", Version: "v1alpha1", Resource: "nodeslos"}

var nodeslosKind = schema.GroupVersionKind{Group: "slo.kooperator", Version: "v1alpha1", Kind: "NodeSLO"}
