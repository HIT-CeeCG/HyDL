...
import (
	...
	slov1alpha1 "Kooperator/apis/slo/v1alpha1"
	clientbeta1 "Kooperator/pkg/client/clientset/versioned/typed/slo/v1alpha1"
	fakeclientslov1alpha1 "Kooperator/pkg/client/clientset/versioned/typed/slo/v1alpha1/fake"
	listerbeta1 "Kooperator/pkg/client/listers/slo/v1alpha1"
	"Kooperator/pkg/koordlet/metriccache"
	mock_metriccache "Kooperator/pkg/koordlet/metriccache/mockmetriccache"
	"Kooperator/pkg/koordlet/statesinformer"
	mock_statesinformer "Kooperator/pkg/koordlet/statesinformer/mockstatesinformer"
...
func (c *fakeNodeMetricClient) Get(ctx context.Context, name string, opts metav1.GetOptions) (*slov1alpha1.NodeMetric, error) {
	...
	if !ok {
		return &slov1alpha1.NodeMetric{}, errors.NewNotFound(schema.GroupResource{Group: "slo.kooperator", Resource: "nodemetrics"}, name)
	}
...
func (c *fakeNodeMetricClient) UpdateStatus(ctx context.Context, nodeMetric *slov1alpha1.NodeMetric, opts metav1.UpdateOptions) (*slov1alpha1.NodeMetric, error) {
	...
	if !ok {
		return &slov1alpha1.NodeMetric{}, errors.NewNotFound(schema.GroupResource{Group: "slo.kooperator", Resource: "nodemetrics"}, nodeMetric.Name)
	}
		...
		},
		{
			...
			fields: fields{
				...
				nodeMetricLister: &fakeNodeMetricLister{
					...
					getErr: errors.NewNotFound(schema.GroupResource{Group: "slo.kooperator", Resource: "nodemetrics"}, "test"),
				},
				nodeMetricClient: &fakeNodeMetricClient{
					nodeMetrics: map[string]*slov1alpha1.NodeMetric{
						"test": {
