...
// getKubeQoSResourceQoSByQoSClass gets pod config by mapping kube qos into kooperator qos.
// https://kooperator/docs/core-concepts/qos/#kooperator-qos-vs-kubernetes-qos
