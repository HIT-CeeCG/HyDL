...
import (
	...
	apiext "Kooperator/apis/extension"
	...
	"Kooperator/pkg/tools/cache"
	"Kooperator/pkg/util"
	"Kooperator/pkg/util/runtime"
	"Kooperator/pkg/util/runtime/handler"
)
...
func Test_CPUEvict_calculateMilliRelease(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			gotCurrentMetricQueryResult, gotRelease := cpuEvictor.calculateMilliRelease(thresholdConfig, windowSize)
