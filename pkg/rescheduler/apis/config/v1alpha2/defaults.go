...
import (
	...
	"Kooperator/pkg/descheduler/apis/config"
	migrationevictor "Kooperator/pkg/descheduler/controllers/migration/evictor"
)
...
func SetDefaults_DeschedulerConfiguration(obj *DeschedulerConfiguration) {
	...
	if len(obj.LeaderElection.ResourceNamespace) == 0 {
		obj.LeaderElection.ResourceNamespace = "kooperator-system"
	}
