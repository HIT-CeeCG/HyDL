...
import (
	...
	sev1alpha1 "Kooperator/apis/scheduling/v1alpha1"
	deschedulerconfig "Kooperator/pkg/descheduler/apis/config"
	"Kooperator/pkg/descheduler/controllers/migration/evictor"
	"Kooperator/pkg/descheduler/controllers/migration/reservation"
	"Kooperator/pkg/descheduler/controllers/migration/util"
	"Kooperator/pkg/descheduler/controllers/names"
	"Kooperator/pkg/descheduler/controllers/options"
	evictionsutil "Kooperator/pkg/descheduler/evictions"
	"Kooperator/pkg/descheduler/framework"
	utilclient "Kooperator/pkg/util/client"
)
...
// +kubebuilder:rbac:groups=scheduling.kooperator,resources=podmigrationjobs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=scheduling.kooperator,resources=podmigrationjobs/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=scheduling.kooperator,resources=reservations,verbs=get;list;watch;create;update;patch;delete
