...
import (
	...
	"Kooperator/apis/runtime/v1alpha1"
	"Kooperator/pkg/runtimeproxy/store"
)
		...
		},
		{
				...
				ContainerInfo: store.ContainerInfo{
					ContainerResourceHookRequest: &v1alpha1.ContainerResourceHookRequest{
						ContainerAnnotations: map[string]string{
							"annotation.dummy.kooperator/TestContainerResourceExecutor_UpdateRequest_A": "true",
						},
			...
			args: args{
				...
				rsp: &v1alpha1.ContainerResourceHookResponse{
					ContainerAnnotations: map[string]string{
						"annotation.dummy.kooperator/TestContainerResourceExecutor_UpdateRequest_B": "true",
					},
					ContainerResources: &v1alpha1.LinuxContainerResources{
						CpuPeriod:   2000,
						CpuShares:   100,
			...
			args: args{
				podReq: &runtimeapi.RunPodSandboxRequest{
					Config: &runtimeapi.PodSandboxConfig{
						...
						Annotations: map[string]string{
							"annotation.dummy.kooperator/TestContainerResourceExecutor_ParseRequest_CreateContainerRequest_Pod": "true",
						},
						Labels: map[string]string{
							"label.dummy.kooperator/TestContainerResourceExecutor_ParseRequest_CreateContainerRequest_Pod": "true",
						},
						Linux: &runtimeapi.LinuxPodSandboxConfig{
				...
				containerReq: &runtimeapi.CreateContainerRequest{
					...
					Config: &runtimeapi.ContainerConfig{
						...
						Annotations: map[string]string{
							"annotation.dummy.kooperator/TestContainerResourceExecutor_ParseRequest_CreateContainerRequest_Container": "true",
						},
						Labels: map[string]string{
							"label.dummy.kooperator/TestContainerResourceExecutor_ParseRequest_CreateContainerRequest_Container": "true",
						},
						Linux: &runtimeapi.LinuxContainerConfig{
