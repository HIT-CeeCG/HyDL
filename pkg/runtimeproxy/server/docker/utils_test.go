...
import (
	...
	resource_executor "Kooperator/pkg/runtimeproxy/resexecutor"
	"Kooperator/pkg/runtimeproxy/server/types"
)
...
func Test_splitLabelsAndAnnotations(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			args: args{
				configs: map[string]string{
					"annotation.dummy.kooperator/test_splitLabelsAndAnnotations": "true",
			...
			wantAnnos: map[string]string{
				"dummy.kooperator/test_splitLabelsAndAnnotations": "true",
			},
		},
	}
	for _, tt := range tests {
...
func Test_toCriCgroupPath(t *testing.T) {
	...
	tests := []testCase{
		...
		{
			"systemd",
			"kooperator-dfsdfsdf.slice",
			"/kooperator.slice/kooperator-dfsdfsdf.slice",
		},
		{
			"systemd",
			"dfsdfsdf.slice",
...
func Test_generateExpectedCgroupParent(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{
				cgroupDriver: "systemd",
				cgroupParent: "/kooperator.slice/kooperator-fsdfsdf.slice",
			},
			expectedCgroupParent: "kooperator-fsdfsdf.slice",
		},
	}
	for _, tt := range tests {
