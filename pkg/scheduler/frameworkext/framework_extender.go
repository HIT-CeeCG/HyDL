...
import (
	...
	kooperatorclientset "Kooperator/pkg/client/clientset/versioned"
...
// to facilitate plugins to access Kooperator's resources and states.
type ExtendedHandle interface {
	framework.Handle
	KooperatorClientSet() kooperatorclientset.Interface
	KooperatorSharedInformerFactory() kooperatorinformers.SharedInformerFactory
...
func WithKooperatorClientSet(kooperatorClientSet kooperatorclientset.Interface) Option {
	return func(options *extendedHandleOptions) {
		options.kooperatorClientSet = kooperatorClientSet
	}
}

func WithKooperatorSharedInformerFactory(informerFactory kooperatorinformers.SharedInformerFactory) Option {
	return func(options *extendedHandleOptions) {
		options.kooperatorSharedInformerFactory = informerFactory
	}
}
...
func NewExtendedHandle(options ...Option) ExtendedHandle {
	...
	return &frameworkExtendedHandleImpl{
		kooperatorClientSet:             handleOptions.kooperatorClientSet,
		kooperatorSharedInformerFactory: handleOptions.kooperatorSharedInformerFactory,
		nrtSharedInformerFactory:        handleOptions.nrtSharedInformerFactory,
	}
}

func (ext *frameworkExtendedHandleImpl) KooperatorClientSet() kooperatorclientset.Interface {
	return ext.kooperatorClientSet
}

func (ext *frameworkExtendedHandleImpl) KooperatorSharedInformerFactory() kooperatorinformers.SharedInformerFactory {
	return ext.kooperatorSharedInformerFactory
}
