...
import (
	...
	"Kooperator/apis/scheduling/config/validation"
	slov1alpha1 "Kooperator/apis/slo/v1alpha1"
	slolisters "Kooperator/pkg/client/listers/slo/v1alpha1"
...
func New(args runtime.Object, handle framework.Handle) (framework.Plugin, error) {
	...
	nodeMetricLister := frameworkExtender.KooperatorSharedInformerFactory().Slo().V1alpha1().NodeMetrics().Lister()
