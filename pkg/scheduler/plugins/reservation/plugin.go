...
func New(args runtime.Object, handle framework.Handle) (framework.Plugin, error) {
	...
	reservationInterface := extendedHandle.KooperatorSharedInformerFactory().Scheduling().V1alpha1().Reservations()
	...
	p := &Plugin{
		...
		client:           extendedHandle.KooperatorClientSet().SchedulingV1alpha1(),
