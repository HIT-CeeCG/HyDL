...
import (
	...
	"Kooperator/apis/scheduling/config"
	"Kooperator/apis/scheduling/config/v1beta2"
	schedulingv1alpha1 "Kooperator/apis/scheduling/v1alpha1"
	koordfake "Kooperator/pkg/client/clientset/versioned/fake"
	clientschedulingv1alpha1 "Kooperator/pkg/client/clientset/versioned/typed/scheduling/v1alpha1"
	kooperatorinformers "Kooperator/pkg/client/informers/externalversions"
	"Kooperator/pkg/client/informers/externalversions/scheduling"
	"Kooperator/pkg/client/informers/externalversions/scheduling/v1alpha1"
	listerschedulingv1alpha1 "Kooperator/pkg/client/listers/scheduling/v1alpha1"
	"Kooperator/pkg/scheduler/frameworkext"
)
...
type fakeKooperatorSharedInformerFactory struct {
	kooperatorinformers.SharedInformerFactory
	v1alpha1.Interface
...
func (f *fakeKooperatorSharedInformerFactory) Scheduling() scheduling.Interface {
	if f.informer != nil {
		return f
	}
	return f.Scheduling()
...
func (f *fakeKooperatorSharedInformerFactory) V1alpha1() v1alpha1.Interface {
	if f.informer != nil {
		return f
	}
	return f.V1alpha1()
...
func (f *fakeKooperatorSharedInformerFactory) Reservations() v1alpha1.ReservationInformer {
	if f.informer != nil {
		return f
	}
...
func (f *fakeKooperatorSharedInformerFactory) Informer() cache.SharedIndexInformer {
	if f.informer != nil {
		return f.informer
	}
	return f.Informer()
...
type fakeExtendedHandle struct {
	...
	koordSharedInformerFactory *fakeKooperatorSharedInformerFactory
}
...
func (f *fakeExtendedHandle) KooperatorSharedInformerFactory() kooperatorinformers.SharedInformerFactory {
	if f.koordSharedInformerFactory != nil {
		return f.koordSharedInformerFactory
	}
	return f.KooperatorSharedInformerFactory()
}
...
func TestNew(t *testing.T) {
	t.Run("test not panic", func(t *testing.T) {
		...
		koordSharedInformerFactory := kooperatorinformers.NewSharedInformerFactory(koordClientSet, 0)
		extendHandle := frameworkext.NewExtendedHandle(
			frameworkext.WithKooperatorClientSet(koordClientSet),
			frameworkext.WithKooperatorSharedInformerFactory(koordSharedInformerFactory),
		)
