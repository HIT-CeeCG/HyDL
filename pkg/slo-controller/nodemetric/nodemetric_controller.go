...
import (
	...
	"Kooperator/pkg/slo-controller/config"
)
...
// +kubebuilder:rbac:groups=slo.kooperator,resources=nodemetrics,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=slo.kooperator,resources=nodemetrics/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=slo.kooperator,resources=nodemetrics/finalizers,verbs=update
