...
// +kubebuilder:rbac:groups=slo.kooperator,resources=nodeslos,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=slo.kooperator,resources=nodeslos/status,verbs=get;update;patch
