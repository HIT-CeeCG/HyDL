...
import (
	...
	configv1alpha1 "Kooperator/apis/config/v1alpha1"
	"Kooperator/apis/extension"
	"Kooperator/pkg/util"
)
...
func TestClusterColocationProfileValidatingPod(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			wantAllowed: false,
			wantReason:  `labels.kooperator/qosClass: Invalid value: "LS": field is immutable`,
		},
		{
			...
			wantAllowed: false,
			wantReason:  `labels.kooperator/qosClass: Invalid value: "": field is immutable`,
		},
		{
		...
		},
		{
			...
			wantAllowed: false,
			wantReason:  `labels.kooperator/qosClass: Required value: must specify kooperator QoS BE with kooperator colocation resources`,
		},
		{
		...
		{
			name:      "validate kooperator priority",
			operation: admissionv1.Update,
			newPod: &corev1.Pod{
				ObjectMeta: metav1.ObjectMeta{
					Labels: map[string]string{
			...
			wantAllowed: false,
			wantReason:  `labels.kooperator/priority: Invalid value: "8888": field is immutable`,
		},
		{
			name:      "validate remove kooperator priority",
			operation: admissionv1.Update,
			newPod: &corev1.Pod{
				ObjectMeta: metav1.ObjectMeta{},
			},
			...
			wantAllowed: false,
			wantReason:  `labels.kooperator/priority: Invalid value: "": field is immutable`,
		},
		{
		...
		},
		{
			...
			wantAllowed: false,
			wantReason:  `Pod: Forbidden: kooperator/qosClass=BE and priorityClass=koord-prod cannot be used in combination`,
		},
		{
			...
			wantAllowed: false,
			wantReason:  `Pod: Forbidden: kooperator/qosClass=LSR and priorityClass=koord-batch cannot be used in combination`,
		},
		{
			...
			wantAllowed: false,
			wantReason:  `Pod: Forbidden: kooperator/qosClass=LSR and priorityClass=koord-mid cannot be used in combination`,
		},
		{
			...
			wantAllowed: false,
			wantReason:  `Pod: Forbidden: kooperator/qosClass=LSR and priorityClass=koord-free cannot be used in combination`,
		},
		{
		...
		},
		{
			...
			wantAllowed: false,
			wantReason:  `[pod.spec.containers.test-container-a.resources.requests.kooperator/batch-cpu: Invalid value: "-1": quantity must be positive, pod.spec.containers.test-container-a.resources.requests.kooperator/batch-memory: Invalid value: "-4Gi": quantity must be positive, pod.spec.containers.test-container-a.resources.limits.kooperator/batch-cpu: Invalid value: "-1": quantity must be positive, pod.spec.containers.test-container-a.resources.limits.kooperator/batch-memory: Invalid value: "-4Gi": quantity must be positive]`,
		},
		{
		...
		},
		{
			...
			wantAllowed: false,
			wantReason:  `pod.spec.containers.test-container-a.resources.requests.kooperator/batch-memory: Required value: request of container test-container-a does not have resource kooperator/batch-memory`,
		},
		{
		...
		},
		{
			...
			wantAllowed: false,
			wantReason:  `[pod.spec.containers.test-container-a.resources.limits.kooperator/batch-cpu: Required value: limit of container test-container-a does not have resource kooperator/batch-cpu, pod.spec.containers.test-container-a.resources: Forbidden: container test-container-a: resource kooperator/batch-cpu quantity should satisify request <= limit, pod.spec.containers.test-container-a.resources.limits.kooperator/batch-memory: Not found: "null", pod.spec.containers.test-container-a.resources: Forbidden: resource kooperator/batch-memory of container test-container-a: quantity of request and limit must be equal]`,
		},
		{
			...
			wantAllowed: false,
			wantReason:  `[pod.spec.containers.test-container-a.resources.requests.kooperator/batch-cpu: Required value: request of container test-container-a does not have resource kooperator/batch-cpu, pod.spec.containers.test-container-a.resources.requests.kooperator/batch-memory: Not found: "null", pod.spec.containers.test-container-a.resources: Forbidden: resource kooperator/batch-memory of container test-container-a: quantity of request and limit must be equal]`,
		},
		{
